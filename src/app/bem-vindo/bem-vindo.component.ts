...
export class BemVindoComponent {
  ...
  slides = [
    ...
    { texto: 'Eu... Eu sou novo no ramo, então não sei muitas coisas.', imagem: 'vitinhoTimido.png' },
    ...
    { texto: 'Eu... Só... Ainda não o testei...', imagem: 'vitinhoTimido.png' },
    ...
    { texto: 'Agora sem mais delongas!', imagem: 'vitinhoSagaz.png' },
    ...
    { texto: 'Encontrei um tesouro que está bem próximo daqui.', imagem: 'vitinhoExplicando.png' },
    { texto: 'Vamos lá!', imagem: 'vitinhoSagaz.png', ehBotaoFinal: true },
  ];

  ngAfterViewInit() {
    // Garante que o botão funcione mesmo inserido via innerHTML
